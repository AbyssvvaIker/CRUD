...
namespace Warehouse.Core.UnitTests.CustomAssertions
{
    ...
    public class ResultAssertions : ReferenceTypeAssertions<Result, ResultAssertions>
    {
        ...
        public ResultAssertions BeSuccess(string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                .BecauseOf(because, becauseArgs)
                .ForCondition(Subject != null)
        ...
        public ResultAssertions BeFailure(string property, string message, string because = "", params object[] becauseArgs)
        {
            Execute.Assertion
                .BecauseOf(because, becauseArgs)
                .ForCondition(Subject != null)
